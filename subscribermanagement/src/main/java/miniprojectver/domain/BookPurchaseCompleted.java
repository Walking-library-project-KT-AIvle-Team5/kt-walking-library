...
@ToString
@NoArgsConstructor
public class BookPurchaseCompleted extends AbstractEvent {
    ...
    public BookPurchaseCompleted(BookPurchaseManagement aggregate) {
        super();
        ...
        this.completedAt = aggregate.getProcessedAt(); // 애그리게이트의 processedAt 사용
